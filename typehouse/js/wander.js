...
(function (G) {
  ...
  function standPoint(room) {
    return { x: LOT * 0.5 - GW * 0.5, y: LOT * 0.52 };
  }
  ...
  function rugPoint() {
    return { x: LOT * 0.42, y: LOT - 22 - GH };
  }

  function propPoint() {
    return { x: LOT * 0.36, y: LOT * 0.34 };
  }

  function meetPoint(dir) {
    var pad = 18;
    var p = { x: LOT * 0.5 - GW * 0.5, y: LOT * 0.46 };
